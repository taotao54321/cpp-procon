#define PROBLEM "https://onlinejudge.u-aizu.ac.jp/courses/lesson/8/ITP2/11/ITP2_11_B"
//#define ERROR "1e-6"
...
void solve() {
    ...
    i64 t = ALL(FOLD, A, 0, [](i64 a, i64 x) { return a | BIT_I(x); });
    i64 mask = t;
    do {
        PRINT(mask);
        PRINT(':');
        ...
        PRINTLN();
    } while(BIT_NEXT_SUPERSET(mask, N, t));
}
